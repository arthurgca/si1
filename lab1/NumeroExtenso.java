public class NumeroExtenso {
	...
	public static String transforma(String valor) throws Exception {
		String s = "";
		if(valor.replaceAll(" ", "").isEmpty()) {
			throw new Exception("Entrada vazia, informe um numero.");
		}
		else { 
			try {
				if (valor.equals("0"))
				...
				throw new Exception("Erro encontrado, não foram informados números."); 
			} 
		} 
	} 
}
